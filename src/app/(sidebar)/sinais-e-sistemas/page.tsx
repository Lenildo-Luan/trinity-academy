...
export default async function Page() {
  const course = getCourse('sinais-e-sistemas');
  let modules: Module[] = await getModules('sinais-e-sistemas');
        ...
        <div className="mx-auto max-w-6xl">
          <div className="relative">
            <div className="px-4 pt-12 sm:pt-48 pb-12 lg:py-24">
              ...
              <h1 className="sr-only">Fundamentos de Sinais e Sistemas</h1>
              <p className="mt-7 max-w-lg text-base/7 text-pretty text-gray-600 dark:text-gray-400">
                Explore os conceitos fundamentais de sinais e sistemas: definições,
                representações contínuas e discretas, implementações em hardware e
                software, e a cadeia de processamento de sinais para engenharia de computação.
              </p>
              ...
              <div className="mt-10">
                <Link
                  href={`/sinais-e-sistemas/charpter-1`}
                      ...
                      {module.lessons.map((lesson) => (
                        <li key={lesson.id}>
                          <ContentLink
                            ...
                            href={`/sinais-e-sistemas/${lesson.id}`}
                            type="video"

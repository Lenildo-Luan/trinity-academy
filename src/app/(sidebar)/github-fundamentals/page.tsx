...
const COURSE_ID = "github-fundamentals";
const COURSE_TITLE = "Fundamentos do GitHub";
...
export default async function Page() {
  let modules: Module[] = await getModules(COURSE_ID);
    ...
    >
      <div className="relative mx-auto max-w-7xl mt-6">
        <div className="absolute -inset-x-2 top-0 -z-10 h-80 overflow-hidden rounded-t-2xl mask-b-from-60% sm:h-88 md:h-112 lg:-inset-x-4 lg:h-128">
          <img
            alt=""
            src="https://ik.imagekit.io/qfmgarse7/github-background.avif"
        ...
        <div className="mx-auto max-w-6xl">
          <div className="relative">
            <div className="px-4 pt-12 sm:pt-48 pb-12 lg:py-24">
              ...
              <h1 className="sr-only">{COURSE_TITLE}</h1>
              <p className="mt-7 max-w-lg text-base/7 text-pretty text-gray-600 dark:text-gray-400">
                Domine o Git e o GitHub do zero: controle de versão, colaboração
                em equipe e as ferramentas essenciais que todo desenvolvedor
                profissional precisa dominar.
              </p>

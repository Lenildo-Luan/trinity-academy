...
export const metadata: Metadata = {
  ...
  description:
    "Domine os fundamentos do Vue.js, o framework JavaScript progressivo para construir interfaces de usuário reativas e modernas.",
};
...
export default async function Page() {
  let modules: Module[] = await getModules("vuejs-fundamentals");
  ...
  return (
    <SidebarLayoutContent
      breadcrumbs={
        <Breadcrumbs>
          <BreadcrumbHome href={"/vuejs-fundamentals"}>
    ...
    >
      <div className="relative mx-auto max-w-7xl mt-6">
        <div className="absolute -inset-x-2 top-0 -z-10 h-80 overflow-hidden rounded-t-2xl mask-b-from-60% sm:h-88 md:h-112 lg:-inset-x-4 lg:h-128">
          <img
            alt=""
            src="https://ik.imagekit.io/qfmgarse7/b286b91b-f5c4-4f25-b0fb-f3a1da720da8.webp"
        ...
        <div className="mx-auto max-w-6xl">
          <div className="relative">
            <div className="px-4 pt-12 sm:pt-48 pb-12 lg:py-24">
              ...
              <h1 className="sr-only">Fundamentos do Vue.js</h1>
              <p className="mt-7 max-w-lg text-base/7 text-pretty text-gray-600 dark:text-gray-400">
                Domine os fundamentos do Vue.js, o framework JavaScript
                progressivo para construir interfaces de usuário reativas e
                modernas, e eleve suas habilidades de desenvolvimento web para o
                próximo nível.
              </p>
              ...
              <div className="mt-10">
                <Link
                  href={`/vuejs-fundamentals/charpter-1`}
                      ...
                      {module.lessons.map((lesson) => (
                        <li key={lesson.id}>
                          <ContentLink
                            ...
                            href={`/vuejs-fundamentals/${lesson.id}`}
                            type="video"

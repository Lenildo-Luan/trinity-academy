...
export default async function Page() {
  const course = getCourse("calculo-1");
  let modules: Module[] = await getModules("calculo-1");
        ...
        <div className="mx-auto max-w-6xl">
          <div className="relative">
            <div className="px-4 pt-12 sm:pt-48 pb-12 lg:py-24">
              ...
              <h1 className="sr-only">Cálculo 1</h1>
              <p className="mt-7 max-w-lg text-base/7 text-pretty text-gray-600 dark:text-gray-400">
                Funções reais de uma variável real, limites, continuidade e
                derivadas com aplicações em problemas de engenharia.
              </p>

...
export default async function Page() {
  const course = getCourse('materiais-micro-nano-tecnologia');
  let modules: Module[] = await getModules('materiais-micro-nano-tecnologia');
        ...
        <div className="mx-auto max-w-6xl">
          <div className="relative">
            <div className="px-4 pt-12 sm:pt-48 pb-12 lg:py-24">
              ...
              <h1 className="sr-only">Materiais para Micro e Nano Tecnologia</h1>
              <p className="mt-7 max-w-lg text-base/7 text-pretty text-gray-600 dark:text-gray-400">
                Explore o fascinante mundo dos materiais para micro e nano
                tecnologia, compreendendo sensores, atuadores e os princípios
                fundamentais que impulsionam a engenharia moderna em escala micro
                e nanométrica.
              </p>
              ...
              <div className="mt-10">
                <Link
                  href={`/materiais-micro-nano-tecnologia/charpter-1`}
                      ...
                      {module.lessons.map((lesson) => (
                        <li key={lesson.id}>
                          <ContentLink
                            ...
                            href={`/materiais-micro-nano-tecnologia/${lesson.id}`}
                            type="video"

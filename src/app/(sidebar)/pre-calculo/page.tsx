        ...
        <div className="mx-auto max-w-6xl">
          <div className="relative">
            <div className="px-4 pt-12 sm:pt-48 pb-12 lg:py-24">
              ...
              <h1 className="sr-only">Pré-Cálculo</h1>
              <p className="mt-7 max-w-lg text-base/7 text-pretty text-gray-600 dark:text-gray-400">
                Fundamentos matemáticos essenciais para o Cálculo 1: números,
                álgebra, funções, trigonometria e introdução ao pensamento
                analítico.
              </p>

...
export async function generateMetadata({
  ...
  let lesson = await getLesson('redes-de-computadores', (await params).slug);

  return {
    title: `${lesson?.title} - Redes de Computadores`,
...
export default async function Page({
  ...
  const moduleName = 'redes-de-computadores';
  let slug = (await params).slug;
  let lesson = await getLesson('redes-de-computadores', slug);
  ...
  let quiz = lesson.quizId ? await getQuiz('redes-de-computadores', lesson.quizId) : null;

  return (
    <SidebarLayoutContent
      breadcrumbs={
        <Breadcrumbs>
          <BreadcrumbHome href={'/redes-de-computadores'}>Redes de Computadores</BreadcrumbHome>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mx-auto flex max-w-2xl gap-x-10 py-10 sm:py-14 lg:max-w-5xl">
          <div className="w-full flex-1">
            ...
            {quiz && (
              <div className="mt-16">
                <QuizSection quiz={quiz} lessonId={lesson.id} courseId="redes-de-computadores" />
              </div>
            )}

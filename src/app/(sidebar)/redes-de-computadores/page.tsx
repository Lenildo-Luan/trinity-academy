        ...
        <div className="mx-auto max-w-6xl">
          <div className="relative">
            <div className="px-4 pt-12 sm:pt-48 pb-12 lg:py-24">
              ...
              <h1 className="sr-only">Redes de Computadores</h1>
              <p className="mt-7 max-w-lg text-base/7 text-pretty text-gray-600 dark:text-gray-400">
                Domine os fundamentos das redes de computadores, desde a camada
                de transporte até protocolos como TCP e UDP, com foco nos
                conceitos essenciais para engenharia de computação.
              </p>
              ...
              <div className="mt-10">
                <Link
                  href={`/redes-de-computadores/charpter-1`}
                      ...
                      {module.lessons.map((lesson) => (
                        <li key={lesson.id}>
                          <ContentLink
                            ...
                            href={`/redes-de-computadores/${lesson.id}`}
                            type="video"

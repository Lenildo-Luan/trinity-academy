...
description: >
  ...
  tone, and learning-centered design. Files are written directly to disk for immediate
  integration.
---
...
4. **Write the .mdx file to disk** (`src/data/lessons/[course]/[chapter].mdx`):
   - Create file with proper MDX formatting
   - Ensure proper directory structure
   - Verify all content is included
5. Ensure consistency with the rest of the course and expected technical level.
6. **Deliver structured output** to Integration Agent:
